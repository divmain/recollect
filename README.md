...
Recollect natively supports all major browsers (IE>9) with the exception of Safari.  Safari support can be attained with the use of a [polyfill](http://nparashuram.com/IndexedDBShim/).  It is asynchronous and non-blocking, and most methods return ES6-compatible promises that resolve to the expected data.
