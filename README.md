...
Recollect natively supports all major browsers (IE>9, Safari<=7.1).  Support in some older browsers can be attained through use of a [polyfill](http://nparashuram.com/IndexedDBShim/).  It is asynchronous and non-blocking, and most methods return ES6-compatible promises that resolve to the expected data.
